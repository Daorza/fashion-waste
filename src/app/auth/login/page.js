      ...
      <div className="flex h-screen w-full items-center justify-center bg-gray-100">
        <div className="md:grid md:grid-cols-2 flex flex-col relative max-w-4xl overflow-hidden rounded-lg bg-white shadow-lg ">
            <div className="md:col-span-1 h-screen md:hidden  block ">
               <Image src={"/models/models1.jpg"} alt="models image" height={1000} width={1000} className="object-cover object-top h-screen"/>
            </div>
              ...
              <div className="h-[38rem] md:h-fit bg-white py-6 rounded-t-2xl md:rounded-none flex flex-col items-center justify-between gap-6 p-4">
                    <div className="flex flex-col items-center gap-6">
                      ...
                      <div className="w-full flex flex-col gap-6 items-center">
                        <input className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-primary focus:border-primary" type="email" placeholder="Email" />
                        <input className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-primary focus:border-primary" type="password" placeholder="password" />
                        <button className="px-4 py-2 bg-primary w-fit text-white rounded-md">
                          Login Now
                        </button>
                    </div>
                    </div>
            ...
            <div className="col-span-1 h-[32rem] hidden md:block">
               <Image src={"/models/models1.jpg"} alt="models image" height={1000} width={1000} className="object-cover object-top h-[32rem]"/>
            </div>
        </div>
    </div>
        </>
