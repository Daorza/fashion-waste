        ...
        <LandingLayout>
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="w-full px-6 flex flex-col gap-12 justify-center items-center mt-16">
                    ...
                    <div className="my-24">
                        <Link href={"#"} className="py-4 px-8 border-2 border-primary  rounded-xl text-white font-bold tracking-widest bg-primary hover:text-primary hover:bg-transparent transition-all duration-200 ">
                            VIEW ALL PRODUCT
                        </Link>  
                    </div>
                </div>
